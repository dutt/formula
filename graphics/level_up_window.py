...
class LevelUpWindow(Window):
    def __init__(self, constants, visible=False):
        super().__init__(
            constants.helper_window_pos, constants.helper_window_size, visible, click_mode=ClickMode.SCROLL,
        )
        self.choices = []
    ...
    def draw(self, game_data, gfx_data):
        ...
        for idx, choice in enumerate(self.choices):
            ...
            y += linediff
        display_text(
            surface, "W/S or up/down to change selection, space to choose", gfx_data.assets.font_message, (50, 500),
        )
